...
$sqlapt="SELECT * FROM appointment_details WHERE (p_id=".$_SESSION["id"].") AND (apt_date >= CAST(CURRENT_TIMESTAMP AS DATE))";
...
<div align=center>
	<div id="mainBody" >
		...
		<div style="padding-top:50px;">
			<div style="margin-right:325px;font-family:Arial;"><h1>Patient Homepage</h1></div>
		</div>
		<div id="dashBar">
		...
		<div align=center>
			<div id="apptButt" onclick="location.href='makeAppointment.php'"> Make An Appointment</div>
		</div>
		<div id="upcommingAppt">
			<div style="font-size:25px;margin-top:5px;" >Upcoming Appointments</div>
			<div >
			<table>
				<?php 
					if ($result->num_rows > 0) {
						...
						while($row = $result->fetch_assoc()) {
							...
							echo "<tr><td><b>Department:</b></td><td> ".$row["dname"]."</td><td> <b>Doctor Name: </b></td><td>".$row2["firstname"]." ".$row2["lastname"]." </td><td> <b>Appointment Date: </b></td><td>".changeDate($row["apt_date"])."</td></tr>";
						}
					} else {
