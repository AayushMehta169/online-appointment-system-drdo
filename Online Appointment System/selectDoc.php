...
$sqldname="SELECT id,firstname,lastname from doctor_details WHERE dept='".$_GET["dname"]."';";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
	...
	$err="";
	$sql="INSERT INTO patient_doctor(p_id,d_id,dname) VALUES(".$_SESSION["id"].",".$_POST["Doctor"].",'".$_GET["dname"]."');";
	if($result = $conn->query($sql))
	{
		$mess="Doctor Updated Successfully.";
	}
...
<div align=center>
	<div id="mainBody" >
		...
		<div class=" bookingSect">
			<h1 style="margin-top:50px; margin-left:15px;">Select the Doctor:</h1><br><br>
			<form method="POST">
				<div id="selDep"><b>Department:</b> 
					<select name="Doctor" id="depDrop">
						<?php
				...
				<br>
				<input type="submit" id="checkAvail" value="Save Doctor" >
			</form>
		</div>
		...
		<div id="errorDiv">
			<div id="closeErr1">
				<div id="errorTop">
					<a style="position:relative;top:4px;margin-left:20px;"><b><?php echo "Doctor Updated!!";?></b></a>
